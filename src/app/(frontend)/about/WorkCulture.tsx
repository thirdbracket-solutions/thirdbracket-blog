        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
          <div>
            ...
            <p className="text-base/[1.6] md:text-lg/[1.75rem] lg:text-xl/[1.85rem] font-light text-primary-600 dark:text-primary-400">
              Our remote-first approach allows us to work with the best talent regardless of
              location, while maintaining a strong sense of community through regular virtual
              collaboration.
            </p>
          </div>

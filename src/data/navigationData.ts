...
export const nextjsSolutionsItems: NavlinkItem[] = [
  ...
  { label: 'LMS Solution', href: '/solutions', isDropdownItem: true },
  { label: 'Blog/Publishing System', href: '/solutions', isDropdownItem: true },
  { label: 'Migration', href: '/solutions', isDropdownItem: true },
  { label: 'Notion Development', href: '/solutions', isDropdownItem: true },
...
export const wordpressSolutionsItems: NavlinkItem[] = [
  { label: 'Rapid Fast WordPress', href: '/solutions', isDropdownItem: true },
  { label: 'Cloud Migration', href: '/solutions', isDropdownItem: true },
  { label: 'Headless WordPress', href: '/solutions', isDropdownItem: true },
  { label: 'Performant WooCommerce', href: '/solutions', isDropdownItem: true },
  { label: 'ACM', href: '/solutions', isDropdownItem: true },
  { label: 'Elementor Templates', href: '/solutions', isDropdownItem: true },
  { label: 'Enterprise Wordpress', href: '/solutions', isDropdownItem: true },
...
export const openSourceSolutionsItems: NavlinkItem[] = [
  { label: 'BracketUI', href: '/solutions', isDropdownItem: true },

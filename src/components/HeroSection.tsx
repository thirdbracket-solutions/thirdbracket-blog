...
export const Hero: React.FC = () => {
  return (
    ...
    //       <div className="flex flex-col items-start sm:items-center space-y-12 sm:space-y-14 lg:space-y-16 sm:max-w-xl  lg:max-w-4xl md:mx-auto">
    //         <h1 className="text-[2.55rem]/[1] font-extrabold md:text-[2.95rem]/[1.1] lg:text-[3.45rem]/[1.1] text-left bg-gradient-primary dark:bg-gradient-secondary-dark text-transparent bg-clip-text sm:text-center   capitalize">
      ...
      <Bracket fluid centered padding="medium">
        <div className="mx-auto max-w-screen-xl">
          <div className="flex flex-col items-start sm:items-center space-y-12 sm:space-y-14 lg:space-y-16 sm:mx-auto max-w-lg md:max-w-2xl lg:max-w-4xl">
            <h1 className="text-[2.55rem]/[1] font-extrabold md:text-[2.95rem]/[1.1] lg:text-[3.45rem]/[1.1] text-left sm:text-center bg-gradient-primary dark:bg-gradient-secondary-dark text-transparent bg-clip-text capitalize">
              Next.js Web Development for UK Agencies & Startups
            </h1>

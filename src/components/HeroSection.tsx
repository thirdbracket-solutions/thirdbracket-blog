...
const HeroSection: React.FC = () => {
  return (
    <section className="flex flex-col items-center  pb-8 sm:pb-12 md:pb-16 pt-20  lg:pt-24  space-y-8 md:space-y-12 lg:space-y-16   mx-auto xl:max-w-6xl lg:max-w-4xl  md:max-w-3xl max-w-md sm:max-w-2xl   bg-[radial-gradient(#f0f0f0_1px,transparent_1px)] dark:bg-[radial-gradient(#1e2026_1px,transparent_1px)]  [background-size:16px_16px] ">
      <a
        href="#"
    ...
    px-2 py-0.5  text-white dark:text-primary-950 
     bg-primary-800 dark:bg-primary-200"
      ...
      {/* Heading */}
      <div className="px-4">
        <h1 className="text-4xl font-extrabold md:text-5xl lg:text-6xl bg-gradient-primary dark:bg-gradient-primary-dark text-transparent bg-clip-text  text-center leading-none  camelcase mb-6">
          Enterprise Web Development & Digital Marketing in Manchester
        </h1>

        {/* 800-#1f2937,900- #111827, 200-#e5e7eb, 100-#f3f4f6  #030712 #f9fafb*/}
        {/* Paragraph */}
        <p className="text-primary-950/60 dark:text-primary-200/60 font-light text-base md:text-lg lg:text-xl/8  text-center lg:px-12 md:px-6 px-2 backdrop-blur-sm">
          We build <span className="font-bold ">custom websites</span>, provide{' '}
          <span className="font-bold ">digital solutions</span>, and drive business
      ...
      <div className="mx-auto py-4 px-4 text-center   lg:px-36">
        ...
        <div className="mt-6 sm:mt-8 flex flex-wrap items-center justify-center text-primary-500 sm:justify-between ">
          <a
            href="#"
            className="mb-5 mr-10 hover:text-primary-700 dark:hover:text-primary-400 lg:mb-0"
          >
            <Tailwind />
          </a>
          <a
